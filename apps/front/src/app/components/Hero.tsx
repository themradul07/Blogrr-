  ...
  return (
    <div className=' bg-gradient-to-br  from-sky-500 to-indigo-500 text-white pt-12'>
        <div className='container mx-auto flex flex-col md:flex-row items-center flex-wrap px-3'>
            {/* left col */}
            <div  className=' flex flex-col  justify-center items-start md:w-2/5 text-center md:text-left'>
                {/* left col */}
                <p className='capitalize tracking-wide w-full'>
                    Explore insights, tutorials, and stories for curious minds like yours
                </p>
                <h2 className='my-5 text-5xl font-bold loading-tight'>Welcome to Sakura Dev Blog</h2>
                <p className='capitalize leading-normal text-xl'>Join the community that thrives on learning, creating and groeing together.{" "}</p>
            </div>
